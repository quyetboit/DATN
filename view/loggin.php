...
<body>
    <?php
        ...
        if(!empty($_POST)) {
            ...
            $sql_check_loggin = "CALL loggin('$username_loggin', '$password_loggin')";
            $data_result = $conn->query($sql_check_loggin);

            if($data_result->num_rows > 0) {
                $_SESSION['user_info'] = $data_result->fetch_assoc();
    ...
    <form class="overlay" id="form-loggin" method="post" action=""> 
        <div class="form__wrap">
            <div class="form__header">Nhập thông tin đăng nhập</div>
            ...
            <div class="form__more-option">
                <span class="form__option">Bạn chưa có tài khoản? <a href="./register.php">Đăng ký</a></span>
